...
module tb_stalling;
  ...
  riscv_pipeline #(
    ...
    .IMEM_FILE("C:/Users/romez/OneDrive/Documentos/proyectos/PipelineC/simulation/programa3_stalling.mem")
  ) dut (
    .clk(clk),
    .reset(reset),
    .PCF(),
  ...
  initial begin
    ...
    if (!saw_stall) begin
      $display("FAIL: no se observo StallF/StallD activo");
      errors = errors + 1;
    end

    finish_test("tb_stalling");
  end
